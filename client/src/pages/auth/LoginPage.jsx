...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <div className="w-1/2 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center p-16">
        <div className="text-center text-white">
          ...
          />
          <h2 className="text-4xl font-bold mb-4">Manage Your Library</h2>
          <p className="text-xl text-blue-50">
            Access thousands of books and track your reading journey
          </p>
        </div>
      </div>
    </div>
